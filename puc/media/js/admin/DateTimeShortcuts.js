...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', '/media/images/icon_clock.gif', 'alt', gettext('Clock'));
    ...
    addCalendar: function(inp) {
        ...
        today_link.appendChild(document.createTextNode(gettext('Hoje')));
        var cal_link = document.createElement('a');
        cal_link.setAttribute('href', 'javascript:DateTimeShortcuts.openCalendar(' + num + ');');
        cal_link.id = DateTimeShortcuts.calendarLinkName + num;
        quickElement('img', cal_link, '', 'src', '/media/images/icon_calendar.gif', 'alt', gettext('Calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));
